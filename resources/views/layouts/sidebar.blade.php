                    ...
                    <ul class="collapse nav flex-column ms-3 ps-3 {{ Route::is('users.index') || Route::is('users.create') || Route::is('roles.index') || Route::is('roles.create') ? 'show' : '' }}"
                        ...
                        @if (Auth::guard('web')->user()->can('user.view') ||
                            ...
                            <li>
                                ...
                                <ul class="collapse nav flex-column ms-3 ps-3 {{ Route::is('users.index') || Route::is('users.create') ? 'show' : '' }}"
                                    id="submenu_1_label_1" data-bs-parent="#submenu1">
                                    @if (Auth::guard('web')->user()->can('user.view'))
                                        <li class="{{ Route::is('users.index') ? 'active' : '' }}">
                                            <a href="{{ url('users') }}" class="nav-link px-0"> <span
                                    ...
                                    @if (Auth::guard('web')->user()->can('user.create'))
                                        <li class="{{ Route::is('users.create') ? 'active' : '' }}">
                                            <a href="{{ url('users/create') }}" class="nav-link px-0"> <span
                            ...
                            <li>
                                <a href="#submenu_2_label_1" data-bs-toggle="collapse" class="nav-link px-0"> <span
                                        class="d-sm-inline"><i class="fa-solid fa-key"></i> Roles <i
                                            class="fa-solid fa-angle-right"></i></span> </a>
                                <ul class="collapse nav flex-column ms-3 ps-3 {{ Route::is('roles.index') || Route::is('roles.create') ? 'show' : '' }}"
                                    id="submenu_2_label_1" data-bs-parent="#submenu1">
                                    @if (Auth::guard('web')->user()->can('role.create'))
                                        <li class="{{ Route::is('roles.index') ? 'active' : '' }}">
                                            <a href="{{ url('roles') }}" class="nav-link px-0"> <span
                                                    class="d-sm-inline"><i class="fa-solid fa-table"></i> Manage
                                                    Roles</span></a>
                                        </li>
                                    @endif
                                    @if (Auth::guard('web')->user()->can('role.create'))
                                        <li class="{{ Route::is('roles.create') ? 'active' : '' }}">
                                            <a href="{{ url('roles/create') }}" class="nav-link px-0"> <span
                                                    class="d-sm-inline"><i class="fa-solid fa-pencil"></i> Create
                                                    Role</span></a>
                                        </li>
                                    @endif
